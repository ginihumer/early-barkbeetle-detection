...
def unet(pretrained_weights = None,input_size = (256,256,1), nr_classes = 3):
    ...
    #conv9 = Conv2D(2, 3, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(conv9) # for binary segmentation
    conv9 = Conv2D(32, 3, activation='relu', padding = 'same', kernel_initializer = 'he_normal')(conv9) # for multi-label segmentation
